...
#             "Оберіть звичку, для якої ви хочете встановити нагадування:\n" + habits_text
#         )
...
#         await message.answer(
#             "Введіть дату та час для нагадування звички (наприклад, 2024-09-15 14:00):"
#         )
...
#         await message.answer(
#             f"Введіть дату та час у валідному форматі (наприклад, {tomorrow} 14:00)."
#         )
#         return
...
#         session.commit()
#         await message.answer(
#             f"Нагадування для звички встановлено на {reminder_datetime.strftime('%Y-%m-%d %H:%M')}."
#         )
